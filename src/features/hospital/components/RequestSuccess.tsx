...
const RequestSuccess: React.FC<ScheduleSuccessModalProps> = ({
  isOpen,
  onClose,
}) => {
  ...
  return (
    ...
    >
      ...
      >
        <h2 className="text-xl font-medium text-gray-900 mb-6">Done</h2>
        ...
        <p className="text-gray-500 text-sm mb-8 font-medium">Request Sent</p>

        <div className="space-y-3">
          <button
            onClick={() => navigate("/hospital/dashboard")}
            className="w-full bg-blue-500 text-white font-bold py-4 rounded-xl hover:bg-blue-600 transition-colors shadow-lg shadow-blue-200"
          >
            Go Home
          </button>
          <button
