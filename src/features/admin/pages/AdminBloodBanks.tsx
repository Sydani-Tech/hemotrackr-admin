...
const AdminBloodBanks = () => {
  ...
  const stats = [
    ...
    },
    {
      ...
      change: "12%",
      isPositive: true,
      icon: Droplet, // Changed icon for Blood Banks context if preferred, or keep Building2
    },
  ];
  ...
  const bloodBanks = [
    ...
    {
      id: 4,
      name: "LHY 768 GT - Mr Johnson Obano",
            ...
            >
              <div className="mb-4 md:mb-0">
                ...
                <p className="text-sm text-gray-500 mt-1">
                  {bank.location} • {bank.date}
                </p>
              </div>

              <div className="flex items-center gap-3">
                <button
                  onClick={() => navigate(`/admin/blood-banks/${bank.id}`)}
