          ...
          <div className="space-y-4">
            {recentDonors.map((donor) => (
              ...
              >
                ...
                <button
                  onClick={() =>
                    navigate(`/blood-bank/update-donor/${donor.id}`)
                  }
                  className="bg-blue-50 text-blue-500 text-xs font-semibold px-4 py-2 rounded-md hover:bg-blue-100 transition-colors"
                >
                  Update Info
                </button>
              </div>
