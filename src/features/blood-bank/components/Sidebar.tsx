...
import { bloodBankRoutes } from "../../../core/routes/BloodBankRoutes";
...
const Sidebar = () => {
  ...
  const primaryRoutes = bloodBankRoutes.filter((route) => !route.section);
  const secondaryRoutes = bloodBankRoutes.filter(
